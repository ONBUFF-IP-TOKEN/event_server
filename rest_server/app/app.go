...
import (
	...
	"github.com/ONBUFF-IP-TOKEN/event-server/rest_server/controllers/externalapi"
	"github.com/ONBUFF-IP-TOKEN/event-server/rest_server/controllers/internalapi"
	"github.com/ONBUFF-IP-TOKEN/event-server/rest_server/controllers/resultcode"
